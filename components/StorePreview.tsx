...
export function StorePreview() {
  return (
    <div className="glass-panel relative overflow-hidden rounded-lg p-5 sm:p-7">
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_50%_0%,rgba(255,153,0,0.16),transparent_34rem)]" />
      <div className="relative rounded-lg border border-white/10 bg-[#050806]/72 p-4">
        <div className="mb-5 flex items-center justify-between gap-4">
          ...
          <div className="rounded-full border border-[#ffb21b]/35 bg-[#ffb21b]/10 px-3 py-1 text-xs font-semibold text-[#ffca63]">
            Coming Soon
          </div>
        </div>
        ...
        <div className="absolute inset-0 flex items-center justify-center bg-[#050806]/42 backdrop-blur-[2px]">
          <div className="flex items-center gap-3 rounded-full border border-[#ffb21b]/35 bg-[#050806]/86 px-5 py-3 text-sm font-semibold text-white shadow-[0_0_60px_rgba(255,153,0,0.22)]">
            <LockKeyhole size={18} className="text-[#ffca63]" />
            Coming Soon
          </div>
        </div>
      </div>
